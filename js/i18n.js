const translations = {
  tr: {
    ...
    "skills.none": "—",
    "cv.title": "CV İndir",
    "cv.intro": "Türkçe ve İngilizce özgeçmişlerimi PDF olarak indirebilirsiniz.",
    "cv.tr": "Özgeçmiş (Türkçe)",
    "cv.en": "Resume (English)",
    "cv.download": "PDF İndir",
    "cv.downloadEn": "PDF İndir",
  ...
  en: {
    ...
    "cv.intro": "Download my Turkish and English résumés as PDF.",
    "cv.tr": "Özgeçmiş (Turkish)",
    "cv.en": "Resume (English)",
    "cv.download": "Download PDF",
    "cv.downloadEn": "Download PDF",
